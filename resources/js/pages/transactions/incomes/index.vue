...
const fetchTransactions = () => {
    router.get(route('transactions.incomes.index'), { // <-- Rota alterada
...
const breadcrumbItems: BreadcrumbItem[] = [{ title: 'Incomes', href: '/transactions/incomes' }]; // <-- Breadcrumb alterado
            ...
            <div class="flex-1">
                ...
                <div class="relative z-10 flex w-full flex-col items-center justify-between gap-4 p-4 sm:flex-row">
                    <div
                        ...
                        <div
                            class="w-full sm:w-48 justify-start text-left font-semibold text-white capitalize flex items-center bg-emerald-600 h-10 px-4 rounded-md">
                            <Icon name="arrow-up-circle" class="mr-2 h-5 w-5" />
                            <span>Incomes</span>
                        </div>
                                    ...
                                    <TableRow>
                                        <TableCell colspan="6" class="py-14">
                                            <div
                                                ...
                                                <div class="text-sm">No incomes found for this month.</div>
                                            </div>
                                        </TableCell>
                                    </TableRow>
                                </template>
