            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="flex items-center justify-between">
                    <label class="flex items-center space-x-2 cursor-pointer">
                        <input type="checkbox" v-model="form.remember" name="remember" class="h-4 w-4 rounded bg-gray-800 border-gray-600 text-lime-500 focus:ring-lime-500" />
                        <span class="text-sm text-gray-300">Remember me</span>
                    </label>
                    <Link
                        v-if="canResetPassword"
                        :href="route('password.request')"
                        class="text-sm font-medium text-lime-400 hover:text-lime-300 transition-colors"
                    >
                        Forgot password?
                    </Link>
                </div>
             ...
             <p class="text-center text-sm text-gray-400">
                ...
                <Link :href="route('register')" class="font-medium text-lime-400 hover:text-lime-300">
                    Sign up
                </Link>
            </p>
        </div>
